...
| [ADR 0005](0005-card-scoped-browser-use-agents.md) | Agentes Browser Use aislados por tarjeta | Aceptado | 2026-09-18 | Capacidad CDP por `browserId`, sidecar fijado, chat y persistencia independientes |
