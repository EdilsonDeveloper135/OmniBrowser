...
- **Profiles:** Personal blue, Trabajo amber, Temporal violet.
...
- Profile rail with Personal, Trabajo, Temporal, and `+ Perfil`.
- Global navigation toolbar, URL entry, `Abrir navegador`, zoom display, and `Guardado` state.
