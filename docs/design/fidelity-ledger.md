...
| Rail | marca, Personal/Trabajo/Temporal, acción inferior | misma jerarquía; badges TEMPORAL explícitos | alta fidelidad |
| Toolbar | navegación, URL, CTA azul, zoom, guardado | mismos controles y orden; colapsa texto de guardado con poco ancho | alta fidelidad responsive |
| Canvas | grid punteado de baja intensidad | grid escalado con pan/zoom y coordenadas | alta fidelidad |
| Tarjetas | chrome compacto, identidad de perfil y foco azul | header React, `WebContentsView` interior e inset de handles | alta fidelidad estructural |
